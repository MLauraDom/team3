...
if ($_POST) {
   ...
   $sql = "INSERT INTO reviews (`question`,`fk_user_id`, `fk_product_id`) VALUES ('$question', $fk_user_id, $fk_product_id);";

   if (mysqli_query($connect, $sql) === true) {
      $class = "success";
      $message = "Thank you for your question! Our Team will answer your question as soon as possible";
   } else {
      $class = "danger";
    ...
    <main>
        ...
        <div class="container py-5 w-50">
            <div
                ...
                <a href='../details.php?id=<?php echo $fk_product_id ?>'><button
                        class="btn btn-outline-dark mt-3 mb-2 py-0 px-5 fw-bold w-100" type='button'>Back</button></a>
            </div>
        </div>
    </main>
    <!-- [FOOTER] -->
