...
if ($_POST) {
    ...
    if ($review !== NULL) {
        $sql = "Update reviews SET question = NULL WHERE review_id = '{$review_id}';";
    } else {
    ...
    if (mysqli_query($connect, $sql) === true) {
        ...
        $class = "success";
        $message = "<p class='mt-4 mb-5 fs-5'>The Question has been successfully <b>Deleted</b>!</p>";
    } else {
        $title = "<i class='bi bi-shield-exclamation-octagon pe-2'></i>ATTENTION";
        $class = "danger";
        $message = "<h2></h2>
            <p class='mt-3 mb-5'>The Question has not been deleted: <br>"
            . $connect->error . "</p>";
    }
